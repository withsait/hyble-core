...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result?.error) {
      setError(result.error.includes("Admin")
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-3">
            ...
            <div className="text-left">
              <span className="text-slate-900 dark:text-white font-semibold text-2xl block">Hyble Admin</span>
              <span className="text-slate-500 dark:text-slate-500 text-sm">Kontrol Paneli</span>
            </div>
          </div>
        </div>
