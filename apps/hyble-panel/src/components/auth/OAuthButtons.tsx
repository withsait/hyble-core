    ...
    <div className="space-y-3">
      {providers.map((provider) => (
        <button
          ...
          className={`w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl font-medium transition-all ${provider.bg} ${provider.text} disabled:opacity-50 disabled:cursor-not-allowed`}
        >
          {loading === provider.id ? (
