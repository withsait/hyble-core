    ...
    <section className="relative min-h-screen flex flex-col justify-center py-6 lg:py-8 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        >
          ...
          >
            <span className="text-slate-900 dark:text-white">Tum Dijital </span>
            <span className="bg-gradient-to-r from-sky-500 to-cyan-500 bg-clip-text text-transparent">Ihtiyaclariniz</span>
            <br className="hidden sm:block" />
            <span className="text-slate-900 dark:text-white">Tek </span>
            <span className="bg-gradient-to-r from-sky-600 to-sky-400 bg-clip-text text-transparent">Platformda</span>
          </motion.h1>
          ...
          >
            Kurumsal web siteleri, e-ticaret cozumleri ve oyun sunuculari -
            <span className="text-sky-600 dark:text-sky-400 font-semibold"> hepsi Hyble&apos;da</span>
          </motion.p>
