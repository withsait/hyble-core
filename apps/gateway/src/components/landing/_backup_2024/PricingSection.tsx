  ...
  return (
    <section id="pricing" className="relative py-16 lg:py-24 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-900 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Custom Order CTA - Daha kullanıcı dostu */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-3">
                  İhtiyacınıza Özel Paket Oluşturalım
                </h3>
                <p className="text-slate-300 mb-6">
                  Her proje benzersizdir. Standart paketler size uymuyorsa, uzman ekibimizle birlikte
                  tam ihtiyacınıza uygun özel bir çözüm tasarlayalım.
                </p>

                {/* Process Steps */}
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                  {[
                    { step: "1", title: "İletişime Geçin", desc: "İhtiyaçlarınızı paylaşın" },
                    { step: "2", title: "Analiz", desc: "Uzmanlarımız incelesin" },
                    { step: "3", title: "Teklif Alın", desc: "Size özel fiyat" },
                  ].map((item) => (
                    <div key={item.step} className="text-center lg:text-left">
                      <div className="w-8 h-8 rounded-full bg-blue-500/30 text-blue-300 font-bold flex items-center justify-center mx-auto lg:mx-0 mb-2">
                        {item.step}
                      </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-6">
                <h4 className="text-lg font-semibold text-white mb-2">Nasıl İletişime Geçmek İstersiniz?</h4>
                <p className="text-sm text-slate-400 mb-6">Size en uygun yöntemi seçin, 24 saat içinde dönüş yapalım.</p>

                <div className="space-y-3">
                  {/* Contact Form Link */}
                  <Link
                    href="/contact"
                    className="w-full flex items-center gap-4 px-5 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-xl font-semibold hover:from-blue-600 hover:to-cyan-600 transition-all group"
                  >
                    <div className="w-10 h-10 rounded-lg bg-white/20 flex items-center justify-center">
                      <Users className="w-5 h-5" />
                    </div>
                    <div className="flex-1 text-left">
                      <p className="font-semibold">İletişim Formu</p>
                      <p className="text-xs text-blue-100">Detaylı bilgi verin, size ulaşalım</p>
                    </div>
                  ...
                  <a
                    ...
                    className="w-full flex items-center gap-4 px-5 py-4 bg-white/10 border border-white/20 text-white rounded-xl hover:bg-white/15 transition-all group"
                  >
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <p className="text-xs text-slate-400">Hızlı yanıt için mesaj atın</p>
                    </div>
                    <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                  </a>
                  ...
                  >
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <p className="text-xs text-slate-400">sales@hyble.co</p>
                    </div>
                    <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                  </a>
                </div>
                ...
                <p className="text-xs text-slate-400 text-center mt-4">
                  Tüm görüşmeler gizlilik içinde yapılır. Ücretsiz danışmanlık.
                </p>
              </div>
            </div>
          </div>
